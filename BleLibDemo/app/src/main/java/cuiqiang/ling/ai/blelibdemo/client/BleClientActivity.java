...
import cuiqiang.ling.ai.blelibdemo.clientTest.BleClientAgent;
import cuiqiang.ling.ai.blelibdemo.clientTest.ClientBleActivity;
...
public class BleClientActivity extends Activity {
    ...
    private void initListener() {
        ...
        mBtnRetry.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                BleClientManager.getInstance().reconnect();
            }
        });
    }
    ...
    private void sendMessageHandle(String msg) {
        ...
        BleClientManager.getInstance().sendMessage(msg);
        mMsgList.add( BleClientManager.getInstance().getDeviceName() + "（本机）：" + msg);
    ...
    public class ReceiveHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (what) {
                ...
                // 处理收到的消息
                case MESSAGE:
                    mMsgList.add(BleClientManager.getInstance().getRmoteDeviceName() + "：" + message);
                    break;
                default:
                    break;
            }
